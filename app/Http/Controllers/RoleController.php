...
class RoleController extends Controller
{
	...
	public function create(Request $request)
	{
		...
		#initialize
		$this->_viewModel->initialize(FormAction::CREATE);
		$this->_viewModel->keepFormData($id, $name, $group, $permission);
		...
		$response = $this->_service->createRole($name, $group, $permission);
	...
	public function showUpdate(Request $request, $id)
	{
		...
		$data = $response->data;
		$this->_viewModel->keepFormData($data['roleId'], $data['roleName'], $data['roleGroup'], $data['rolePermission'], $data['updateAt']);
		$this->_viewModel->success();
	...
	public function update(Request $request)
	{
		...
		$name 		= $request->input('name');
		$group 		= $request->input('group');
		$permission	= $request->array('permission'); #空值時, 若用input: NULL / array: []
		...
		$response = $this->_service->updateRole($id, $name, $group, $permission);
