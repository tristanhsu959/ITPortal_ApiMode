...
<html lang="en">
	...
	<body class="responsive">
		...
		<main x-data :class="{ 'login': @json(Route::is('login')), 'app': !@json(Route::is('login')) }"  class="responsive">
			<div class='content-wrapper'>
				@if(!Route::is('login'))
					@include('layouts._action-bar')
				@endif
				
				@yield('content')
			</div>
			@if(!Route::is('login'))
				@include('layouts._profile.blade')
